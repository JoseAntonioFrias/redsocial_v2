...
class Detalle extends Component {
  ...
  comprobarSolicitud() {
    ...
    // Si no utilizaramos localStorage, habríamos hecho un get inicial que nos habría guardardo en el store, 
    //'solicitudes' esta información de entrada, ahora solo funciona si llevamos un rato dentro del mismo usuario y sin refrescar página,
    // por eso tiene más prioridad el localStorage.
